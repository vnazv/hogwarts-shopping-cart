                ...
                :key="item.id">
                    ...
                    <div class="item-details-with-actions">
                        <div class="item-details">
                            ...
                            <p class="in-stock-status" v-if="item.inStock"> 
                        ...
                        <div class="item-actions">
                            <div class="quantity-selector">
                                ...
                                @click="decreaseOne(item.id)">−</button>
                                <input 
                                type="text" 
                                ...
                                >
                                <button class="quantity-change-button" 
                                @click="increaseOne(item.id)">+</button>
                            </div>
...
let shoppingCartItems = ref([
    {
        ...
        quantity: 3,
        inStock: true,
        imageUrl:"src/assets/img/DragonLiver.png"
    },
    {
        id: 2,
        ...
        quantity: 2,
        inStock: true,
        imageUrl: "src/assets/img/GoldenSnitch.png"
    },
    {
        id: 3,
        ...
        imageUrl: "src/assets/img/UnicornTailHair.png"
    },
    {
        id: 4,
        productName: "Wand",
        ...
        quantity: 1,
        inStock: true,
        imageUrl: "src/assets/img/Wand.jpg"
    },
    {
        id: 5,
        ...
        quantity: 1,
        inStock: true,
        imageUrl: "src/assets/img/Nimbus2000.jpg"
    }
])
...
let subtotal = computed(() =>
   shoppingCartItems.value.reduce((acc, item) =>
...
watch(shoppingCartItems, () => {
    localStorage.setItem('hogwartsShoppingCart',
